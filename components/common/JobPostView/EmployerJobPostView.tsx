...
interface EmployerJobPostViewProps {
  jobData: JobPostData;
...
const EmployerJobPostView: React.FC<EmployerJobPostViewProps> = ({
  jobData,
  onEdit,
  onPublish,
  onSaveEdit,
...
export default EmployerJobPostView;
