...
export function toPrismaJobType(value: JobType): $Enums.JobType {
  const map: Record<JobType, $Enums.JobType> = {
    ...
    [JobType.EVENT_STAFF]: "EVENT_STAFF",
    [JobType.PACKER]: "PACKER",
    [JobType.CONSTRUCTION_WORKER]: "CONSTRUCTION_WORKER",
    [JobType.MAINTENANCE]: "MAINTENANCE",
    [JobType.LANDSCAPER]: "LANDSCAPER",
    [JobType.ADMIN_ASSISTANT]: "ADMIN_ASSISTANT",
    [JobType.DATA_ENTRY]: "DATA_ENTRY",
    [JobType.CONTENT_CREATOR]: "CONTENT_CREATOR",
    [JobType.PHOTOGRAPHER]: "PHOTOGRAPHER",
    [JobType.VIDEOGRAPHER]: "VIDEOGRAPHER",
    [JobType.MECHANIC]: "MECHANIC",
    [JobType.CARPENTER]: "CARPENTER",
    [JobType.PAINTER]: "PAINTER",
    [JobType.CHILDCARE]: "CHILDCARE",
    [JobType.ELDERCARE]: "ELDERCARE",
    [JobType.PET_CARE]: "PET_CARE",
    [JobType.TUTOR]: "TUTOR",
  };
  return map[value];
}
...
export function fromPrismaJobType(value: string): JobType {
  const map: Record<string, JobType> = {
    ...
    HOST: JobType.HOST,
    HOUSEKEEPING: JobType.HOUSEKEEPING,
    EVENT_STAFF: JobType.EVENT_STAFF,
    PACKER: JobType.PACKER,
    CONSTRUCTION_WORKER: JobType.CONSTRUCTION_WORKER,
    MAINTENANCE: JobType.MAINTENANCE,
    LANDSCAPER: JobType.LANDSCAPER,
    ADMIN_ASSISTANT: JobType.ADMIN_ASSISTANT,
    DATA_ENTRY: JobType.DATA_ENTRY,
    CONTENT_CREATOR: JobType.CONTENT_CREATOR,
    PHOTOGRAPHER: JobType.PHOTOGRAPHER,
    VIDEOGRAPHER: JobType.VIDEOGRAPHER,
    MECHANIC: JobType.MECHANIC,
    CARPENTER: JobType.CARPENTER,
    PAINTER: JobType.PAINTER,
    CHILDCARE: JobType.CHILDCARE,
    ELDERCARE: JobType.ELDERCARE,
    PET_CARE: JobType.PET_CARE,
    TUTOR: JobType.TUTOR,
  };
