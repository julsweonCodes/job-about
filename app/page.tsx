      ...
      <main className="flex-1 pt-20 pb-32 px-5 sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center">
          <div className="mb-8">
            ...
            <div className="mt-4">
              <button className="w-full flex items-center justify-center border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-full text-lg font-semibold md:text-2xl hover:shadow-xl transform transition-all duration-300">
