...
export default function JobPostCreatePage() {
  ...
  const [jobType, setJobType] = useState<string>(""); // string[] → string
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto bg-white min-h-screen">
        ...
        <div className="w-full mx-auto flex-1 flex flex-col px-4 pb-5 bg-white">
            ...
            <div>
              ...
              <div className="flex gap-2">
                {LANGUAGE_LEVELS.map((level) => (
                  <Chip
                    key={level.value}
                    selected={languageLevel === level.value}
